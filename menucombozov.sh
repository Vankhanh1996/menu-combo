...
function panelcrack(){  
bash <(curl -Ls https://raw.githubusercontent.com/Vankhanh1996/vankhanh/main/script/Z_OVpanel.sh)
...
# anti l4
function anti-l4(){
bash <(curl -Ls https://raw.githubusercontent.com/Vankhanh1996/menu-combo/main/lo4.sh)
red "anti l4 hoàn tất."
}

function blockspeed(){
bash <(curl -Ls https://raw.githubusercontent.com/Vankhanh1996/menu-combo/main/blockspeedtest.sh)
}

function hacap(){
wget -O "/root/LinuxPanel_EN-6.8.23.zip" "https://github.com/Vankhanh1996/menu-combo/raw/main/LinuxPanel_EN-6.8.23.zip"
blue "đang tải tệp zip."
unzip LinuxPanel_EN-6.8.23.zip
cd /root/panel
wget -O "/root/panel/confhacap.sh" "https://raw.githubusercontent.com/Vankhanh1996/menu-combo/main/confhacap.sh" 
...
function start_menu(){
    ...
    purple " zalo     : 0397333616"
    purple " facebook : https://zalo.me/0397333616"
    yellow " ————————————————————————————————————————————————"
